...
export const optimizeScheduleWithAI = async (
  ...
  // Use the custom environment variable name 'guard' as requested by the user.
  // We also keep a fallback to API_KEY to ensure compatibility with different environments.
